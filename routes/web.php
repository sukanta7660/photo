...
Route::get('profile','User\OtherPageController@profile')->middleware('verified');
    //review
    Route::post('photographer/review/save','User\PhotographerController@review');
    Route::get('photographer/review/del/{id}','User\PhotographerController@remove_cmnt');
    //review
...
//================= Booking ===================
        ...
        Route::get('admin/booking/reject/{id}','Admin\BookingController@reject');
        Route::get('admin/booking/rejected','Admin\BookingController@rejected');
//================= /Booking ==================
...
//================ Photos =====================
        ...
        Route::post('admin/gallery/multiple-photoDelete','Admin\PhotosController@deleteAll');
//================ /Photos ====================
