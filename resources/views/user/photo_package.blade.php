                ...
                <div class="col-md-4">
                    <div class="my-single-collapse">
                        <ul class="border-black">
                            <li class="bg_color_orange">{{$row->packageName}}</li>
                        </ul>
                        <ul class="ul-border">
                        ...
                        <ul class="border-black">
                            <li class="bg_color_orange">{{money($row->amount)}}</li>
                        </ul>
                        <a class="bg_color_orange" href="{{action('User\PackageBookingController@photo_package_booking_page',['id' => $row->photoPackageID, 'slug' => $row->slug])}}">Book Now</a>
                    </div>
                </div>
                @endforeach
            </div>
