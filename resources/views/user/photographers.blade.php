                    ...
                    <div class="single-our-best-instructor">
                        <div class="best-instructor-img">
                            ...
                            <div class="inner-best-instructor">
                                <ul>
                                    <li><a target="_blank" href="https://www.facebook.com/{{$row->facebook}}"><i class="fa fa-facebook"></i></a></li>
                                    <li><a target="_blank" href="https://www.twitter.com/{{$row->twitter}}"><i class="fa fa-twitter"></i></a></li>
                                    <li><a target="_blank" href="https://www.instagram.com/{{$row->instagram}}"><i class="fa fa-instagram"></i></a></li>
                                </ul>
