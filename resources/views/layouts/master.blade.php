...
<head>
    ...
    <!-- Title -->
    <title>@yield('title') | Photographs</title>
    <!-- Font Google -->
...
<div class="chat-box">
    <div class="chat-main">
        <img width="100" height="100" src="{{asset('public/assets/img/icon/msngr.png')}}" class="icon_chat">
    </div>
</div>
...
<!-- Manific Popup JS -->
<script src="{{asset('public/assets/js/jquery.magnificpopup.min.js')}}"></script>
<!-- One Page Nav JS -->
